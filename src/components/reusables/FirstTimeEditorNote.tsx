  ...
  return (
    <div>
      <Message>
        ...
        <ul>
          <li>
            The wikitext code should be added on <b><i>Wiki Editor</i></b>, not <i>Visual Editor</i>. <a href="https://en.wikipedia.org/wiki/Help:Editing" target="_blank" rel="noopener noreferrer">Click this link for a more detailed guide on editing.</a>
          </li>
          {
            addRedirectNote &&
            <li>
